                    ...
                    <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
                        ...
                        <div class="bg-gradient-to-br from-blue-50/70 to-indigo-50/70 backdrop-blur-sm rounded-3xl p-8 border border-blue-200/30 shadow-lg">
                            ...
                            <div class="space-y-6">
                                ...
                                @if(isset($peminjaman->user))
                                <div class="bg-gradient-to-r from-indigo-50 to-purple-50 backdrop-blur-sm rounded-2xl p-6 shadow-inner border border-indigo-200">
                                    <label class="text-sm font-semibold text-gray-600 uppercase tracking-wide flex items-center mb-3">
                                    ...
                                    <div class="bg-white/80 rounded-xl p-4">
                                        <div class="flex items-center space-x-4">
                                            <div class="w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full flex items-center justify-center shadow-lg">
                                                <span class="text-white font-bold text-lg">{{ substr($peminjaman->user->name, 0, 1) }}</span>
                                            </div>
                                            <div class="flex-1">
